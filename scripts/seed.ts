...
const homepageDoc = {
  ...
  heroCTAHref: "/recipes",
  featuredRecipes: [
    { ...ref("recipe-pho-bo"), _key: "fr-pho-bo" },
    { ...ref("recipe-banh-mi"), _key: "fr-banh-mi" },
    { ...ref("recipe-curry-lilek"), _key: "fr-curry-lilek" },
    { ...ref("recipe-nudle-krevety"), _key: "fr-nudle-krevety" },
    { ...ref("recipe-jarni-zavitky"), _key: "fr-jarni-zavitky" },
    { ...ref("recipe-salat-papaja"), _key: "fr-salat-papaja" },
  ],
  featuredArticles: [
    { ...ref("article-vejce"), _key: "fa-vejce" },
    { ...ref("article-steak"), _key: "fa-steak" },
    { ...ref("article-pantry"), _key: "fa-pantry" },
    { ...ref("article-street-food"), _key: "fa-street-food" },
  ],
  seo: {
    _type: "seo",
